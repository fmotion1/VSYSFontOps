...
namespace VSYSFontOps.Fonts
{
    ...
    public sealed class VariableFontRecord
    {
        public string FontPath { get; private set; }
        public string FontFilename { get; private set; }
        public string isVariable { get; private set; }
        public Array AxesTags {get; private set;}
    }
    ...
    public sealed class FontRecord
    {
        public string FontPath { get; private set; }
        public string FontFilename { get; private set; }
        public string FontIsVariable { get; private set; }
